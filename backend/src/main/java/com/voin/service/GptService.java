...
public class GptService {
    ...
    public Map<String, String> classifyValue(String userInput) {
        ...
        request.setMessages(List.of(
                new GptMessage("system", "너는 사용자가 작성한 다양한 유형의 글(일상 기록, 자신의 사례 회고, 친구의 사례 회고)에서 장점 카테고리와 키워드를 정확하게 분류하고,
                50~60자 분량의 존댓말로 자연스럽고 풍부하게 요약하는 AI야. 반드시 아래 절차와 정의를 따르며,
                입력이 동일하면 항상 동일한 결과를 내야 해.\\n\\n### 절차\\n
